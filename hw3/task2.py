...
obj_points[:,:2] = np.mgrid[0:corners_x,0:corners_y].T.reshape(-1,2)*3.88

for num in range(1,35):
    #Left image
    img_path_l = "stereo_L"+str(num)+".png"
    ...
    #Right image
    img_path_r = "stereo_R"+str(num)+".png"
...
criteria_specs = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, max_iter, 0.001)
